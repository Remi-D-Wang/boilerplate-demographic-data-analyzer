...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((df[(df['salary'] == '>50K') & 
                            ((df['education'] == 'Bachelors') | 
                                (df['education'] == 'Masters') | 
                                (df['education'] == 'Doctorate'))].shape[0] / higher_education * 100), 1)

    lower_education_rich = round((df[(df['salary'] == '>50K') & 
                            ~((df['education'] == 'Bachelors') | 
                                (df['education'] == 'Masters') | 
                                (df['education'] == 'Doctorate'))].shape[0] / lower_education * 100), 1)
    ...
    country_earning_percentage = df['native-country'][df['salary']=='>50K'].value_counts()/df['native-country'].value_counts()
    highest_earning_country = country_earning_percentage.idxmax()
    highest_earning_country_percentage = round(country_earning_percentage.max() * 100, 1)
